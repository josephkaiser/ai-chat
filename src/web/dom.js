...
export const reasoningOverlay = query("#reasoningOverlay");
export const closeReasoningButton = query("#closeReasoningButton");
export const reasoningTitle = query("#reasoningTitle");
export const reasoningScope = query("#reasoningScope");
export const reasoningContent = query("#reasoningContent");
