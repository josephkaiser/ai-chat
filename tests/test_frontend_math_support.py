...
class FrontendMathSupportTests(unittest.TestCase):
    ...
    def test_repo_includes_local_frontend_build_entrypoint(self):
        ...
        self.assertIn("do_kickstart() {", chat_launcher)
        ...
        self.assertIn('docker_compose build --no-cache chat-app', chat_launcher)
        self.assertIn('kickstart) do_kickstart ;;', chat_launcher)
